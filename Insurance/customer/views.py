...
from insurancemanagement import models as CMODEL
from insurancemanagement import forms as CFORM
...
def ihs_view(request):
    return render(request, 'ihs.html')
...
def shield_view(request):
    return render(request, 'insurance/shield.html')


def team_view(request):
    return render(request, 'insurance/team.html')


def travel_view(request):
    return render(request, 'insurance/travel.html')
